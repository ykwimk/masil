...
export default function FeaturesSection() {
  return (
    <section id="why" className="scroll-mt-[72px] bg-white py-16 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div
          id="experiment"
          className="mt-12 grid scroll-mt-[72px] grid-cols-1 items-center gap-8 md:gap-12 lg:grid-cols-2"
        >
          <motion.div
